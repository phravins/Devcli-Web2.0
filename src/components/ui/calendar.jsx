...
import {
  DayPicker,
  getDefaultClassNames, DayButton,
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day)[data-selected=true]_button]:rounded-l-md"
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "data-[selected-single=true]) flex-col gap-1 leading-none font-normal group-data-[focused=true]/day=true]/day=true]/day=true]:rounded-md data-[range-end=true]:rounded-r-md data-[range-middle=true]:rounded-none data-[range-start=true]:rounded-md data-[range-start=true]:rounded-l-md [&>span]:text-xs [&>span]:opacity-70",
        defaultClassNames.day,
        className
      )}
      {...props}
